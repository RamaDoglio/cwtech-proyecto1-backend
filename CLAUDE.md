...
- Si la decisión también toca el frontend, registrala en los dos repos y enlazá una entrada con
  la otra.

## Nota específica del back

Las reglas de negocio (precio, margen, stock mínimo) **viven acá**, en el dominio. Si un prompt
te lleva a resolver una regla en un controller, un DTO o una query, o a "arreglar" en el front
algo que el back hace mal, eso es deuda técnica: registralo en `DECISIONES-IA.md` y proponé
llevarlo a la capa que corresponde.
